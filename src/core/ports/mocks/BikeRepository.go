...
// BikeRepository is an autogenerated mock type for the BikeRepository type
type BikeRepository struct {
	mock.Mock
}

// Create provides a mock function with given fields: bike
func (_m *BikeRepository) Create(bike domain.Bike) (*domain.Bike, error) {
	ret := _m.Called(bike)
...
func (_m *BikeRepository) Delete(bike domain.Bike) error {
	ret := _m.Called(bike)
...
func (_m *BikeRepository) Get(bikeID uuid.UUID) (*domain.Bike, error) {
...
func (_m *BikeRepository) List(filter value.BikeListFilter) (*domain.Bikes, error) {
